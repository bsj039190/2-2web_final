...
$selrec="select * from announce where title='$title'";
...
<?php
$uprec="update announce set hits=hits+1 where no=$data[no]";
$info2=mysqli_query($connect,$uprec);
mysqli_close($connect);
?>
<button><a href="javascript:history.back()">목록으로 이동</a></button>
</body></html>